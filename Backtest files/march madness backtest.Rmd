...
To get ROI above, I assume you entered $1/bracket and first place gets everything. So, for example percentile-99 means you are using .99 as the parameter and that the payout is $100 if the actual percentile was >=.99. So if I entered 1 bracket each year and won 20 dollars, my ROI=(20-8)/8*100=150%. Below I look more closely at the .90-parameter backtest:
...
As you can see, optimization on 90th percentile still gave the best result, even in a larger pool. But while the ROI is higher, the percentage of winning years starts to decrease. I repeat this again using 100-man pool scoring:
