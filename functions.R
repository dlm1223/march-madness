...
coordTeam<-function(x){
  ...
  x[x=="saint bonaventure"|x=="saint bonavent"|x=='saint bon']<-"st bonaventure"
  ...
  x[x=="North Carolina-Greensboro"|x=="NC Greensboro"|x=="North Carolina Greensboro"|x=="Greensboro"|x=="Nc Grnsboro"|x=='North Carolina Greens']<-"Unc Greensboro"
