...
coordName<-function(x){
  ...
  x[x=="north carolina-wilmington"|x=="unc willmington"|x=="unc wilmgton"|x=="north carolina wilmgton"]<-"unc wilmington"
  ...
  x[x=="Csub"|x=="CS Bakersfield"|x=="Bakersfield"|x=="Cal State Bakersfld"|x=="Cal St Bakersfld"]<-"Cal State Bakersfield"
  ...
  x[x=="Cal State Sacramento"|x=="Cal St Sacramento"|x=="Sac State"]<-"Sacramento State"
  ...
  x[x=="Lbsu"|x=="Lg Beach State"|x=="Long Beach St"|x=="Lg Beach St"]<-"Long Beach State"
