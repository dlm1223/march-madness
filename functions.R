...
coordName<-function(x){
  ...
  x[x=="fl gulf coast"|x=="fgcu"|x=="gulf coast"|x=="Gulf Coast"]<-"florida gulf coast"
  x[x=="tx southern"]<-"texas southern"
  ...
  x[x=="ms valley st"]<-"mississippi valley st"
  x[x=="northwestern la"]<-"northwestern st"
  ...
  x[x=="Southern University"]<-"Southern"
