...
#model 3##
fit3<-glm(Win_factor~I(log(Rank.SAG/OPP.SAG))+I(Rank.POM-OPP.POM)+Teamloc_num,
...
##model 4##
fit4<-glm(Win_factor~I(Rank.POM-OPP.POM)+I(TeamSeed_num^2-OPPSeed_num^2),
          family="binomial", data=train[train$Tournament==1,]);summary(fit4)
